function ps_search() {
  function addCSSHead() {
    let stlyeElt = document.createElement("style");
    stlyeElt.type = "text/css";
    stlyeElt.innerHTML = ".active-result{display:block;}";
    $("head").append(stlyeElt);
  }
  addCSSHead();
  $("[ps-element^='wrapper']").each(function () {
    ...
    let activeResultClass = elem.attr("ps-result-active") || "active-result";
    ...
    if (searchTigger == "input") {
      ...
      searchInput.on("input", function () {
        ...
        searchResultWrapper.addClass(activeResultClass);
    ...
    searchInput.on("blur", function () {
      ...
      searchResultWrapper.removeClass(activeResultClass);
...
//$("[ps-element='input']").css("pointer-events", "none");
window.fsAttributes = window.fsAttributes || [];
window.fsAttributes.push([
  "cmsfilter",
  (filterInstances) => {
    $("[ps-element='input']").css("pointer-events", "auto");
    ps_search();
  }
]);
